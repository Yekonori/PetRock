...
public class ControllerType : MonoBehaviour
{
    ...
    public void _GetInputTypeFromGUID(System.Guid guid, Player player)
    {
    ...
    void SetPlaystation(Player player)
    {
        player.controllers.maps.SetMapsEnabled(true, 17);
